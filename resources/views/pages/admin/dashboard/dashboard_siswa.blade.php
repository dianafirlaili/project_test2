                                        ...
                                        <div class="ticket-detail">
                                            ...
                                            <div class="ticket-info">
                                                <div class="font-weight-600">
                                                    {{ $datasiswa->kelas != null ? $datasiswa->kelas->tingkatan . ' ' . $datasiswa->kelas->jurusan . ' ' . $datasiswa->kelas->suffix : ' Kelas tidak ditemukan' }}
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-5 col-5 mt-0 ml-5">
                                                    ...
                                                    <input type="text" name="nomerinduk" id="nomerinduk"
                                                        ...
                                                        value="{{ old('nomerinduk') ? old('nomerinduk') : $datasiswa->nomerinduk }}"
                                                        readonly>
                                                    @error('nomerinduk')
                                                ...
                                                <div class="form-group col-md-5 col-5 mt-0 ml-5">
                                                    ...
                                                    <input type="text" name="nama" id="nama"
                                                        ...
                                                        value="{{ old('nama') ? old('nama') : $datasiswa->nama }}" readonly>
                                                    @error('nama')
                                                        <div class="invalid-feedback"> {{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="form-group col-md-5 col-5 mt-0 ml-5">
                                                    ...
                                                    <input type="text" name="tempatlahir" id="tempatlahir"
                                                        ...
                                                        value="{{ old('tempatlahir') ? old('tempatlahir') : $datasiswa->tempatlahir }}"
                                                        required>
                                                    @error('tempatlahir')
                                                        <div class="invalid-feedback"> {{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group col-md-5 col-5 mt-0 ml-5">
                                                    ...
                                                    <input type="date" name="tgllahir" id="tgllahir"
                                                        ...
                                                        value="{{ old('tgllahir') ? old('tgllahir') : $datasiswa->tgllahir }}"
                                                        required>
                                                    @error('tgllahir')
                                                        <div class="invalid-feedback"> {{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="form-group col-md-5 col-5 mt-0 ml-5">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="email" required
                                                        value="{{ old('email') ? old('email') : $datasiswa->users->email }}">
