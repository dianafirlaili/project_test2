                        ...
                        <div class="card-wrap">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-muted text-small"><span class="text-primary"><i
                                            class="fas fa-caret-up"></i></span> {{ $jmlkelas }} Kelas</div>
                        ...
                        @forelse ($mapel as $m)
                            @php
                                ...
                                foreach ($ambildataajar as $d) {
                                    $jmlkd = DB::table('kompetensidasar')
                                        ->whereNull('deleted_at')
                                        ->where('dataajar_id', $d->id)
                                        ->count();
                                    $totalkd += $jmlkd;
                                    $jmlsoal = DB::table('banksoal')
                                        ->whereNull('deleted_at')
                                        ->where('dataajar_id', $d->id)
                                        ->count();
                                    $totalsoal += $jmlsoal;
                            ...
                            <div class="col text-center col-6 col-md-3 mt-2">
                                ...
                                <img alt="image"
                                    src="https://ui-avatars.com/api/?name={{ $m->nama }}&color=7F9CF5&background=EBF4FF&length=3"
                                    class="img-thumbnail" data-toggle="tooltip" title="{{ $m->nama }}" width="100px"
                                    height="100px" style="object-fit:cover;">

                                <div class="mt-2 font-weight-bold">{{ $m->nama }}</div>
                                <div class="text-muted text-small"><span class="text-primary"><i
                                            class="fas fa-caret-up"></i></span> {{ $totalkd }} Silabus </div>
                                <div class="text-muted text-small"><span class="text-primary"><i
                                            class="fas fa-caret-up"></i></span> {{ $totalsoal }} Soal </div>
                            </div>
