...
class adminkelascontroller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.admin.kelas.index', compact('datas', 'request', 'pages', 'guru', 'tapel'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.admin.kelas.create', compact('pages', 'tapel', 'walikelas'));
    }
